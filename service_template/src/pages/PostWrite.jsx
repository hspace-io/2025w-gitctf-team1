    ...
    try {
      ...
      if (post) {
        ...
        setFormData({
          ...
          endDate: endDate,
          schedule: schedule,
          recruitCount: post.recruitmentCount || post.recruitCount,
          difficulty: difficultyMap[post.difficulty] || post.difficulty,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const postData = {
        ...
        eventDate: schedule,
        recruitmentCount: parseInt(formData.recruitCount),
        difficulty: difficultyMap[formData.difficulty] || formData.difficulty,
        clubName: user?.clubName || formData.clubName || null,
